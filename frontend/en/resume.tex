...
% PDF metadata
\hypersetup{
    pdftitle={Hamza EL MASSOUDI Frontend Resume},
...
\begin{center}
    ...
    \smallskip
    Frontend Developer \textbar\ Casablanca, Morocco\\
    \smallskip
...
% --------------------------------------------------
\section*{Summary}
Frontend Developer with expertise in building responsive and interactive user interfaces. Proficient in React, Next.js, and modern JavaScript frameworks. Created engaging web applications with seamless user experiences, integrating with backend APIs and optimizing performance.
